...
import FoundindStory from "../assets/Images/FoundingStory.png"
...
const About = () => {
  return (
    <div>
        ...
        <section>
          <div className='mx-auto w-11/12 max-w-maxContent flex flex-col text-richblack-500'>
          ...
          {/* left */}
            ...
            <img src={FoundindStory} alt="FoundindStory"  className="shadow-[0_0_20px_0] shadow-[#FC6767]" />
